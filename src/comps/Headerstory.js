      ...
      <main className="container p-5">
        <div className="row">
          ...
          <div className="col-lg-8">
            ...
            <br/>
            <h4>
              I my name is pini winer Married to Leah With two wonderful children. I have experience working on projects and working with people, managing client portfolios and meeting deadlines in a printing company. 
               I learn fast and i know what it takes to close gaps by myself, in the last year I did an intensive programming course to add the technical toolkit 
               to my project management skills and pursue a career in tech.
